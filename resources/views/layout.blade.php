...
<body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="index.html" class="logo d-flex align-items-center">
                <img src="{{ asset('assets') }}/img/p.png" alt="p">
                <span class="d-none d-lg-block">Rumah Sakit</span>
            </a>
            ...
            <ul class="d-flex align-items-center">
                ...
                <li class="nav-item dropdown pe-3">
                    ...
                    <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#"
                        ...
                        <span class="d-none d-md-block dropdown-toggle ps-2">RS ROSATI</span>
    ...
    <main id="main" class="main">
        ...
        <footer id="footer" class="footer">
            <div class="copyright">
                &copy; Copyright <strong><span>Hana</span></strong>. All Rights Reserved
            </div>
