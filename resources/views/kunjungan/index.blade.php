        ...
        <div class="container">
            <div class="card">
                <div class="card-header text-center">
                    <h1 class="font-weight-bold">Data Kunjungan Pasien</h1>
                </div><!-- End Page Title -->
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                                        ...
                                        <tbody>
                                            @foreach ($kunjungans as $i => $kunjungan)
                                                <tr>
                                                    ...
                                                    <td>
                                                         <form action="{{ route('kunjungan.destroy', $kunjungan->id_kunjungan) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                            <a class="btn btn-warning"
                                                                href="{{ route('kunjungan.edit', $kunjungan->id_kunjungan) }}">Ubah</a>
                                                        ...
                                                        <a class="btn btn-secondary"
                                                            href="{{ route('kunjungan.show', $kunjungan->id_kunjungan) }}">Lihat
                                                            Detail</a>
                                                    </td>
                                                </tr>
                                            @endforeach
