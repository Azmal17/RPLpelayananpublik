...
<head>
  ...
  <link rel="stylesheet" href="<script src="https://kit.fontawesome.com/2d26295c33.js" crossorigin="anonymous"></script>">
...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__wobble" src="{{ asset('template/dist/img/logo1.png') }}" alt="AdminLTELogo" height="60" width="60">
  </div>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="{{ asset('template/dist/img/logo1.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">Pelayanan Publik</span>
    </a>
...
{{--           
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2023. RPLpelayananpublik
    </strong>
    All rights reserved.
