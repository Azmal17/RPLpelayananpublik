              ...
              <div class="col-8">
                  ...
                  <div class="card-body">
                    <form action="/updateData/<?php echo e($data->id); ?>" method="post" enctype="multipart/form-data">
                      ...
                      <div class="mb-3">
                        ...
                        aria-describedby="emailHelp" value="<?php echo e($data->no_pengaduan); ?>">
                      </div>
                      <div class="mb-3">
                        ...
                        aria-describedby="emailHelp" value="<?php echo e($data->nama_pengadu); ?>">
                      </div>
                      <div class="mb-3">
                        ...
                        <select class="form-select" name="bagian_layanan" aria-label=".form-select-sm example">
                          <option selected><?php echo e($data->bagian_layanan); ?></option>
                ...
                       </select>
                      ...
                      <div class="mb-3">
                        ...
                        aria-describedby="emailHelp" value="<?php echo e($data->email); ?>">
                      </div>
                      <div class="mb-3">
                        ...
                        aria-describedby="emailHelp" value="<?php echo e($data->no_hp); ?>">
                      </div>
                      <div class="mb-3">
                        ...
                        aria-describedby="emailHelp" value="<?php echo e($data->tanggal_kunjungan); ?>">
                      </div>
                      <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Isi Pengaduan</label>
                        <input type="text" name="isi_pengaduan" value="<?php echo e($data->isi_pengaduan); ?>" class="form-control" id="exampleInputEmail1"
...
</html><?php /**PATH C:\Users\lenovo\crudpp-app\resources\views/tampilData.blade.php ENDPATH**/ ?>